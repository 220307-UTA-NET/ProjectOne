...
CREATE TABLE VLLibrary.Rentals (
    ...
    MemberID INT NOT NULL FOREIGN KEY REFERENCES VLLibrary.Accounts (MemberID) ON UPDATE CASCADE ON DELETE CASCADE,
    BookID INT NOT NULL FOREIGN KEY REFERENCES VLLibrary.Books (BookID) ON UPDATE CASCADE ON DELETE CASCADE,
