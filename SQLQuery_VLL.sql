...
GO
ALTER TABLE [VLLibrary].[Accounts] ADD PRIMARY KEY CLUSTERED 
(
	[MemberID] ASC
...
GO
ALTER TABLE [VLLibrary].[Books] ADD PRIMARY KEY CLUSTERED 
(
	[BookID] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
ALTER TABLE [VLLibrary].[Books] ADD  DEFAULT ((1)) FOR [InStock]
GO
...
GO
ALTER TABLE [VLLibrary].[Rentals] ADD PRIMARY KEY CLUSTERED 
(
	[RentalID] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
ALTER TABLE [VLLibrary].[Rentals] ADD  DEFAULT (getdate()) FOR [OutDate]
GO
ALTER TABLE [VLLibrary].[Rentals]  WITH CHECK ADD FOREIGN KEY([BookID])
REFERENCES [VLLibrary].[Books] ([BookID])
GO
ALTER TABLE [VLLibrary].[Rentals]  WITH CHECK ADD FOREIGN KEY([MemberID])
REFERENCES [VLLibrary].[Accounts] ([MemberID])
GO
